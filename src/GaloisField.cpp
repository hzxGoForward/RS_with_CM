...
void gf256_ctx::gf256_mul_mem_init()
{
    ...
    for (int y = 0; y < 256; ++y)
    {
        ...
        if (CpuHasNeon)
        {
            MM128.TABLE_LO_Y[y] = vld1q_u8(lo);
            MM128.TABLE_HI_Y[y] = vld1q_u8(hi);
        }
        ...
        _mm_storeu_si128(MM128.TABLE_LO_Y + y, table_lo);
        _mm_storeu_si128(MM128.TABLE_HI_Y + y, table_hi);
# ifdef GF256_TRY_AVX2
        if (CpuHasAVX2)
        {
            ...
            _mm256_storeu_si256(MM256.TABLE_LO_Y + y, table_lo2);
            _mm256_storeu_si256(MM256.TABLE_HI_Y + y, table_hi2);
        }
# endif // GF256_TRY_AVX2
#endif // GF256_TARGET_MOBILE
    }
...
void gf256_ctx::gf256_mul_mem(void * GF256_RESTRICT vz, const void * GF256_RESTRICT vx, uint8_t y, int bytes)
{
    ...
    if (bytes >= 16 && CpuHasNeon)
    {
        ...
        const GF256_M128 table_lo_y = vld1q_u8((uint8_t*)(MM128.TABLE_LO_Y + y));
        const GF256_M128 table_hi_y = vld1q_u8((uint8_t*)(MM128.TABLE_HI_Y + y));
...
# if defined(GF256_TRY_AVX2)
    ...
    {
        // Partial product tables; see above
        const GF256_M256 table_lo_y = _mm256_loadu_si256(MM256.TABLE_LO_Y + y);
        const GF256_M256 table_hi_y = _mm256_loadu_si256(MM256.TABLE_HI_Y + y);
...
# endif // GF256_TRY_AVX2
    ...
    {
        // Partial product tables; see above
        const GF256_M128 table_lo_y = _mm_loadu_si128(MM128.TABLE_LO_Y + y);
        const GF256_M128 table_hi_y = _mm_loadu_si128(MM128.TABLE_HI_Y + y);
